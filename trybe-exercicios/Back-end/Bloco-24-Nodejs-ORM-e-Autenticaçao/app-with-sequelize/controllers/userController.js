...
router.get('/:id', async (req, res) => {
  ...
  router.put('/:id', async (req, res) => {
    try {
      ...
      console.log('UPDATE', updateUser); // confira o que é retornado quando o user com o id é ou não encontrado;
  ...
  router.delete('/:id', async (req, res) => {
    try {
      ...
      console.log('console de delete', deleteUser) // confira o que é retornado quando o user com o id é ou não encontrado;
